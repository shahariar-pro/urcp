  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col transition-colors">
      ...
      <main className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 flex-1 space-y-6">
        ...
        {/* Immutability Banner */}
        <div className="flex items-center gap-2.5 p-3 rounded-xl bg-slate-900 dark:bg-slate-900 border border-slate-800 text-slate-100 text-xs shadow-xs">
                ...
                {(!logs || logs.length === 0) ? (
                  ...
                  logs.map((log: any) => (
                    <tr key={log.id} className="hover:bg-slate-50/70 dark:hover:bg-slate-800/40 transition-colors">
                      <td className="px-5 py-3.5 whitespace-nowrap text-slate-600 dark:text-slate-300 font-mono text-[11px]">
                      ...
                      <td className="px-5 py-3.5 text-slate-500 dark:text-slate-400 font-mono text-[11px] max-w-xs truncate">
