      ...
      <main className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 flex-1 space-y-8">
        ...
        {(profile.role === "faculty" || profile.role === "admin") &&
          ...
          pendingProposals.length > 0 && (
            <div className="p-4 rounded-xl border border-amber-200 bg-amber-50/80 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            {(!memberProjects || memberProjects.length === 0) ? (
              <Card className="border-dashed bg-white">
                <CardContent className="p-10 text-center text-slate-500 space-y-3">
              ...
              <div className="grid grid-cols-1 gap-3">
                {memberProjects.map((item: any) => {
                  ...
                  return (
                    <Card
                      key={proj.id}
                      className="hover:border-blue-300 hover:shadow-xs transition-all bg-white"
                    >
          ...
          <div className="space-y-6">
                  ...
                  {(!userProposals || userProposals.length === 0) ? (
                    ...
                    <div className="space-y-3">
                      {userProposals.slice(0, 4).map((p: any) => (
                        <div
                          key={p.id}
                          className="p-3 rounded-lg border border-slate-100 bg-slate-50/50 space-y-1 text-xs"
                        >
            ...
            {profile.role === "admin" && (
              <Card className="bg-white shadow-2xs border-purple-200">
                <CardHeader className="pb-3 border-b border-purple-100 bg-purple-50/50 rounded-t-lg">
