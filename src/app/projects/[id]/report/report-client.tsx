...
export function ReportClient({
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="bg-white border-slate-200 shadow-sm p-8 sm:p-12 print:border-none print:shadow-none print:p-0">
        <div className="space-y-8">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-slate-700 leading-relaxed whitespace-pre-wrap bg-slate-50/50 p-4 rounded-lg border border-slate-100">
              {project.abstract}
            </p>
          </div>
                ...
                <tbody className="divide-y divide-slate-100">
                  {milestones.map((m: any) => (
                    <tr key={m.id}>
                      ...
                      <td className="p-2.5 text-right capitalize text-slate-700">
                        {m.status.replace("_", " ")}
                      </td>
                    </tr>
                  ))}
          ...
          <div className="pt-12 grid grid-cols-2 gap-12 text-center text-xs">
            ...
            <div className="border-t border-slate-400 pt-2">
              <p className="font-semibold text-slate-900">Lead Student Researcher</p>
              <p className="text-slate-500">CSC 3114 Research Team</p>
            </div>
          </div>
        </div>
      </Card>
