    ...
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        ...
        {confirmedMeetings.length === 0 ? (
          <p className="text-xs text-slate-400 italic py-4 bg-white p-4 rounded-xl border border-dashed text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {confirmedMeetings.map((m) => (
              <Card
                key={m.id}
                className="bg-white border-emerald-200 shadow-2xs"
              >
        ...
        {pendingMeetings.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {pendingMeetings.map((m) => (
              <Card
                key={m.id}
                className="bg-white border-amber-200 shadow-2xs"
              >
